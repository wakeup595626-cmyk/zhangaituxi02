...
def call(session_id, request_id, tool_name, arguments):
    ...
    print("CODEX_UI_{}={}".format(tool_name.upper(), text))
    return text


def main():
    session_id = initialize()
    call(session_id, 2, "Windows", {"action": "list", "index": -1})
    call(session_id, 3, "Observe", {"ref": "", "maxDepth": 0})
    call(session_id, 4, "Snapshot", {"ref": "", "maxDepth": 4})
